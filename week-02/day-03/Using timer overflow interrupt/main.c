/*
 * Using timer overflow interrupt.c
 *
 * Created: 2017. 05. 10. 16:32:54
 * Author : Z
 */ 
...
void init()
{
	// Set the prescaler to 1024 division. See at the TC0 control register in the data sheet!
