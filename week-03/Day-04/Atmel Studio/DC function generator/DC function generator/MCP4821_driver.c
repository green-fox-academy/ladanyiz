...
void MCP4821_Init() {
	...
	SPI_MOSI_DDR |= 1 << SPI_MOSI_DDR_POS; // PORTB3 as MOSI output
	SPI_SCK_DDR |= 1 << SPI_SCK_DDR_POS; // PORTB5 as clock output
	SPI_SS_DDR |= 1 << SPI_SS_DDR_POS; // PORTB2 as Slave Select output
	...
	// Default values are good for us.
