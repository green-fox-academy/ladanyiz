/*
 * UART with rx circular buffer.c
 *
 * Created: 2017. 05. 16. 13:20:23
 * Author : Z
 */ 
...
#define RX_CIRC_BUFF_LEN 512

//TODO: Create the circular buffer with the length of RX_CIRC_BUFF_LEN
	volatile char rx_circ_buff[RX_CIRC_BUFF_LEN];

//TODO: Create the head pointer of the buffer
	volatile char* rx_circ_buff_head = &rx_circ_buff;

//TODO: Create the tail pointer of the buffer
	volatile char* rx_circ_buff_tail = &rx_circ_buff[RX_CIRC_BUFF_LEN-1];
